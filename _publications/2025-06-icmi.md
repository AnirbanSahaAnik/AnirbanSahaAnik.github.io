...
excerpt: 'We introduce a hybrid attention-guided fusion network with Grad-CAM for interpretable and accurate MPox skin lesion classification, demonstrating high diagnostic performance on a curated dataset.'
abstract: |
  The rapid identification of MPox in skin lesion images is crucial to restrain its spread. Current diagnostic systems often struggle to distinguish between diseases with similar visual features, such as chickenpox, measles, cowpox, HFMD, and healthy skin, increasing the likelihood of misdiagnosis. We propose an Attention-Guided Fusion Network (AGFN) that combines a Convolutional Neural Network (CNN) backbone for feature extraction with a multi-head attention block, enhancing representation through contextual fusion. Our model incorporates ResNet50 for strong feature extraction alongside a multi-head attention mechanism that emphasizes critical patterns, facilitating accurate classification among six categories: MPox, chickenpox, measles, cowpox, HFMD, and healthy skin. Interpretability is enhanced by Grad-CAM (Gradient-weighted Class Activation Mapping), which generates class-specific activation maps highlighting the key regions driving the model's decisions. Trained and tested on 755 images across these categories, our model achieved 99.81% accuracy, 99.92% precision, 99.67% recall, and a 99.79% F1 score, underscoring its potential for real-world clinical application.
date: 2025-01-01
venue: '2025 IEEE 4th International Conference on Computing and Machine Intelligence (ICMI)'
venue_short: 'ICMI 2025'
paperurl: 'https://ieeexplore.ieee.org/abstract/document/11141216'
codeurl: ''
dataseturl: ''
bibtexurl: '/files/bibtex/2025-icmi.bib'
paperurl_text: 'IEEE Xplore: document 11141216'
...
## Resources
- 📄 **Paper**: [IEEE Xplore](https://ieeexplore.ieee.org/abstract/document/11141216)
